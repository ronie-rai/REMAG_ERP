...
function TestReportPrint() {
  ...
  const [jobMetaLoaded, setJobMetaLoaded] = useState(false)
  ...
  useEffect(() => {
    if (!record || !jobMetaLoaded) return
  ...
  return (
    <Box sx={{ p: 2, '@media print': { p: 0 } }}>
      ...
      >
        <Box ref={contentRef} className="test-report-print-scale">
          <style>{`
            .tr-table {
              width: 100%;
